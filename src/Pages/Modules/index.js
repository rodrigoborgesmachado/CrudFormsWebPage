    ...
    return (
        <div className='containerpage'>
            ...
            <div className='texto'>
                ...
                <h4>
                    Para a instalção do sistema CrudForms, é necessário ir na aba "instaladores", na tela inicial do site.Quando você clicar nesta aba aparcerá uma lista das versões do CrudForms, basta clicar em "baixar versão" e o sistema já estará sendeo baixado na sua máquina. O sistema passa por atualizações, portanto baixe semprea ultima versão diponibilizada.
                </h4>
                ...
                <h4>
                    Essa opção seleciona o banco de dados que você deseja conectar para fazer consultas. Essa opção abre umajanela  na qual é preenchido
                    <br />
